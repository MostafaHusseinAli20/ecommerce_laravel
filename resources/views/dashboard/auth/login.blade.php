...
<div class="login-box">
    ...
    <div class="login-logo">
        <a href=""><b>Login |</b> Admin Panel</a>
    ...
    <div class="login-box-body">
        ...
        <form action="{{ route('admin.login') }}" method="post">
            ...
            <h6 class="text-center">if You don't have been account go to <a href="{{ url('/dashboard/registerPage') }}" class="text-primary">Register</a></h6>
